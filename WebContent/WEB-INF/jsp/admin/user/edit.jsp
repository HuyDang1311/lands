			...
			<div>
				<form action="" method="post">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
								<label for="name">Tên đăng nhập</label> <input type="text"
									required="required" name="username" value="${objUser.username}"
									disabled class="form-control" placeholder="Nhập tên đăng nhập">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label for="name">Họ và tên</label> <input type="text"
									required="required" minlength="3" maxlength="32"
									class="form-control" value="${objUser.fullname}"
									name="fullname" placeholder="Nhập họ và tên">
							</div>
						</div>
						<div class="col-sm-12">
							<div class="form-group">
								<label>Phân cấp:</label> <select name="rid" class="form-control">
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label for="name">Nhập mật khẩu cũ</label> <input
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label for="name">Nhập mật khẩu mới</label> <input
									type="password" minlength="8" maxlength="32"
						...
						<div class="col-sm-12">
							<div class="form-group">
								<label for="name">Nhập lại mật khẩu mới</label> <input
									type="password" minlength="8" maxlength="32"
