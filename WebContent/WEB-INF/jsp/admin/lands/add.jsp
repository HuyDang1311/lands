						...
						<div class="col-sm-10">
							...
							<div class="form-group">
								<label for="name" class="require">Tên tin:</label> <input
									type="text" class="form-control" value="${param.lname}"
							...
							<div class="form-group">
								<label for="name" class="require">Diện tích(m2):</label> <input
									type="number" step="any" value="${param.area}"
							...
							<div class="form-group">
								<label for="name" class="require">Giá:</label> <input
									type="text" value="${param.gia}" class="form-control"
									name="gia" placeholder="Nhập giá bán" required="required">
							</div>

							<div class="form-group">
								<label class="require">Địa chỉ:</label>
								<textarea class="form-control" value="" rows="3" name="address"
									placeholder="Nhập địa chỉ" required="required">${param.address}</textarea>
							</div>

							<div class="form-group">
								<label for="name" class="require">Tên liên hệ:</label> <input
									type="text" class="form-control" value="${param.tenlh}"
							...
							<div class="form-group">
								...
								<textarea class="form-control" value="" rows="3" name="dclienhe"
									placeholder="Nhập địa chỉ liên hệ" required="required">${param.dclienhe}</textarea>
							</div>

							<div class="form-group">
								<label for="name" class="require">Số điện thoại liên hệ:</label>
								<input type="text" value="${param.sdt}" class="form-control"
							...
							<div class="form-group">
								<label for="name" class="require">Vỹ độ:</label> <input
									type="text" class="form-control" value="${param.lat}"
									placeholder="Nhập vỹ độ" name="lat" required="required">
							</div>

							<div class="form-group">
								<label for="name" class="require">Kinh độ:</label> <input
									type="text" class="form-control" value="${param.lng}"
									placeholder="Nhập kinh độ" name="lng" required="required">
							</div>

							<div class="form-group">
								<label>Mô tả</label>
								<textarea class="form-control, ckeditor" value=""
									name="description" rows="3" required="required">${param.description}</textarea>
							</div>
